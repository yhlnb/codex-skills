...
description: Generate Xiaohongshu cover copy, post titles, and cover composition plans from a spoken script, storyline, topic idea, rough outline, or content draft. Use when the user asks for Xiaohongshu title ideas, cover text, thumbnail/cover layout, eye-catching but authentic hooks, or packaging content around their personal creator tone.
---
...
Produce 8 selected options unless the user asks for another count. Mark the strongest 3 as `Top 1`, `Top 2`, and `Top 3`.
...
2. Generate cover/title options around that hook.
...
- At least 3 options have obvious click reasons.
- At least 1 option invites comments or saves.
...
```markdown
我会把这条内容包装成「核心情绪/主题」。最推荐先试 Top 1-3。
